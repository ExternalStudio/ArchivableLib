...
> **Archivable Library** — это современная, быстрая и эстетичная библиотека интерфейсов для читов на Roblox Luau, разработанная с упором на плавность, эффекты размытия и простоту использования.
