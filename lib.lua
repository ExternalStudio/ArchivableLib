...
local ArchivableFilesSession = Instance.new("Folder")
ArchivableFilesSession.Name = "session_" .. tostring(generatedRandomString)
ArchivableFilesSession.Parent = ArchivableFiles
--]]
------------------------------------------------------------------------------------
--GUI
------------------------------------------------------------------------------------
